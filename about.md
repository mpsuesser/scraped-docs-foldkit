...
The site is also built to be read by agents. Every page is available as Markdown, the full documentation is available as one file, and a read-only JSON [Content API](https://foldkit.dev/api) describes the site to a program.
